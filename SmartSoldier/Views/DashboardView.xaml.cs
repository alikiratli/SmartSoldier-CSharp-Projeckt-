...
namespace SmartSoldier.Views
{
    public partial class DashboardView : UserControl
    {
        ...
        {
            // Simuliere sich ändernde Distanzen
            double distanceWalked = 2.8 + (_random.NextDouble() * 0.5); // 2.8 - 3.3 km
            double distanceToTarget = Math.Max(0.1, 1.2 - (_random.NextDouble() * 0.3)); // 0.9 - 1.2 km
            ...
            // Navigationstext basierend auf Distanz
            string navText;
            ...
            {
                string[] directions = { "Geradeaus 200m, dann links", "Rechts abbiegen in 150m", "Weiter geradeaus 300m" };
                navText = directions[_random.Next(directions.Length)];
            }
